...
function init() {
    ...
    map = new OpenLayers.Map('map', projection: 'EPSG:3857', center: lonlat });
    ...
    controls = {polygon: new OpenLayers.Control.DrawFeature(polygonLayer, OpenLayers.Handler.Polygon)} 
